  ...
  <div class="row">
    <div class="col-lg-3 col-md-6 text-center">
      <div class="service-box mt-5 mx-auto">
        ...
        <img class="howWorks" src="/images/where.jpg" alt="Destination"/>
    ...
    <div class="col-lg-3 col-md-6 text-center">
      <div class="service-box mt-5 mx-auto">
        ...
        <img class="howWorks" src="/images/dates.jpg" alt="Dates"/>
    ...
    <div class="col-lg-3 col-md-6 text-center">
      <div class="service-box mt-5 mx-auto">
        ...
        <img class="howWorks" src="/images/whether.jpg" alt="Weather"/>
    ...
    <div class="col-lg-3 col-md-6 text-center">
      <div class="service-box mt-5 mx-auto">
        ...
        <img class="howWorks" src= "/images/pack.jpg" alt="Outfit"/>
